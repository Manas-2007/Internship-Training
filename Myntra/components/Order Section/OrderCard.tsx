  ...
  return (
    ...
    >
      ...
      >
          ...
          return (
            <View key={index} className="flex-row mb-5 items-center">
              ...
              <View className="ml-4 md:ml-5 justify-center flex-1">
                <Text
                  className="text-[10px] md:text-xs font-bold tracking-widest uppercase mb-1.5"
                  numberOfLines={1}
                  style={{ color: colors.textMuted }}
                >
                  {product.brand || "Brand"}
                ...
                <Text
                  className="text-xs md:text-sm font-medium mb-1.5"
                  style={{ color: colors.textMuted }}
                >
                  Size:{" "}
                  <Text
        ...
        >
          <Text
            className="font-bold text-xs md:text-sm tracking-widest uppercase mr-2"

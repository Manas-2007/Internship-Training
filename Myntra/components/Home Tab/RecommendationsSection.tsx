...
export default function RecommendationsSection({ recommendations, isLargeScreen }: RecommendationsProps) {
  ...
  return (
    <View className="mt-10 px-4 lg:px-8 mb-10">
      <Text className="text-lg md:text-xl font-bold tracking-wide mb-6 uppercase" style={{ color: colors.textMain }}>
        You May Also Like
      </Text>
        ...
        {recommendations.map((product: any) => (
          ...
          >
            ...
            <View className="p-2 md:p-3">
              ...
              <Text className="font-bold text-sm md:text-base" style={{ color: colors.textMain }}>
                ₹{product.price}
              </Text>
            </View>
          </TouchableOpacity>
